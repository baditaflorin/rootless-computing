...
Each entry includes which principles it demonstrates (by number from the [manifesto](../MANIFESTO.md)) and which adjacent concepts it relies on (Pages-Native, BTB = Bake-Time Backend, Mesh, ZK, Fiducials).
...
- Principles: 1, 2, 3, 4, 5, 6, 8, 9
- Uses: Pages-Native, BTB, Mesh, ZK
...
- Principles: 1, 2, 3, 4, 6, 7, 8
- Uses: Pages-Native, Mesh, Fiducials
...
- Principles: 1, 2, 3, 6, 7, 8
- Uses: Pages-Native, BTB, Fiducials (compass anchors)
...
- Principles: 1, 2, 4, 5, 6, 8
- Uses: Pages-Native, Mesh, ZK (anonymity)
...
- Uses: <comma-separated adjacent concepts: Pages-Native, BTB, Mesh, ZK, Fiducials, IPFS, etc.>
```
